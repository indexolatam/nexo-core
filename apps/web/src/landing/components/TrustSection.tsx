    ...
    <section className="surface-section py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-wide text-[var(--accent)]">{CLIENT.landing.trust.overline}</p>
          <h2 className="mt-3 text-3xl font-bold text-surface-main sm:text-4xl">
            {CLIENT.landing.trust.heading}
          </h2>
          <p className="mt-4 text-surface-secondary">
            {CLIENT.landing.trust.description}
          </p>
        </div>
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {CLIENT.landing.trust.items.map((item) => (
